export const tokenInfo = {
  bnUSD: `Balanced Dollars (bnUSD) is a stablecoin backed by ICX, tied to the value of 1 USD. It’s the first synthetic asset created on Balanced, and the first stablecoin for the ICON Network. It was created to replace ICX for payments, trades, and in-app purchases within the ICON ecosystem, and beyond.`,
  ...
  ICX: `ICON is a decentralized blockchain network focused on interoperability, and ICX is the native cryptocurrency. If you stake ICX in a supported wallet, you'll earn regular staking rewards, based on ICON's variable reward rate (currently x% per year).
  <br /><br />
