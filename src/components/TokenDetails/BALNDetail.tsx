...
const BALNDetail = ({ token }: TokenDetailProps) => {
  return (
    <>
      ...
      <TokenDetails>
        <TokenInfo>
          {`The Balance Token (BALN) is the Balanced governance token. When staked, it entitles the holder to voting rights and a share of the network fees. You can earn Balance Tokens by using Balanced: either take out a loan, or supply liquidity to the exchange.`}
          <LineBreak />
